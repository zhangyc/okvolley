...
public class CacheDispatcher extends Thread {
    ...
    /** The queue of requests coming in for triage. 缓存阻塞队列*/
     ...
     * @param delivery Delivery interface to use for posting responses传递界面用于回复
     */
    ...
    private void processRequest() throws InterruptedException {
        ...
        // Attempt to retrieve this item from cache。取出缓存
        Cache.Entry entry = mCache.get(request.getCacheKey());
        if (entry == null) {
            request.addMarker("cache-miss");
            // Cache miss; send off to the network dispatcher.没有缓存
